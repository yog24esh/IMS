...
public class ReportController {
	...
	public ModelAndView getDetailsByDate(@ModelAttribute("dateRangeBean") DateRangeBean dateRangeBean) {
		ModelAndView modelAndView = new ModelAndView();
		System.out.println("========\nRunning Submit Date Range BEan\n======");
		List<PurchaseEntryBean>  purchaseEntryBeanList=new ArrayList<PurchaseEntryBean>();
		purchaseEntryBeanList=reportByDateService.getDetailsByDate(dateRangeBean.getFromDate(),dateRangeBean.getToDate());
		modelAndView.setViewName("PurchaseEntryDetailsByDate");
		modelAndView.addObject("purchaseEntryBeanList",purchaseEntryBeanList);
		System.out.println("\n"+purchaseEntryBeanList);
		return modelAndView;
