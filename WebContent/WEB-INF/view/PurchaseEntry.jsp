...
<body>
	...
	<center>
		...
		<form:form name="form1" modelAttribute="purchaseEntryBean"
			method="POST">
			<table>
				<tr>
					<td>Vendor Name</td>
					<td width="150px"><form:select path="vendorName">
				...
				<tr>
					...
					<td width="150px"><form:select id="customerId"
							onchange="getmattypeAndUnit(customerId.value)"
		...
		<c:if test="${purchaseEntryBean.materialCategoryId!=null}">
			<form:form name="form2" modelAttribute="purchaseEntryBean"
				method="POST" action="addPurchaseEntry.html">
				<table>
					<tr>
						<td>Material Type</td>
						<td width="150px"><form:select path="materialTypeId">
								<form:option label="---SELECT---" value=""></form:option>
					...
					<tr>
						<td>Brand Name</td>
						<td width="150px"><form:input path="brandName" /> <form:errors
								path="brandName" cssClass="error"></form:errors></td>
					</tr>
					<tr>
						<td>Unit</td>
						<td width="150px"><form:select path="unitId">
								<form:option label="---SELECT---" value=""></form:option>
					...
					<tr>
						<td>Quantity</td>
						<td width="150px"><form:input path="quantity" /> <form:errors
								path="quantity" cssClass="error"></form:errors></td>
					</tr>
					<tr>
						<td>Purchase Amount</td>
						<td width="150px"><form:input path="purchaseAmount" /> <form:errors
								path="purchaseAmount" cssClass="error"></form:errors></td>
					</tr>

					<tr>
						<td>Purchase Date</td>
						<td width="150px"><form:input id="datepicker"
								path="purchaseDate" /></td>
					</tr>
					<tr>
