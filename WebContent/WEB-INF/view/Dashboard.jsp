...
<body>
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">Pricing</a>
			...
			<li class="nav-item"><a class="nav-link"
				href="${pageContext.request.contextPath}//loadPurchaseEntryPage.html">PURCHASE ENTRY</a>
			</li>

			<li class="nav-item"><a class="nav-link"
				href="${pageContext.request.contextPath}/getDateRangeBean.html">GET DETAILS BY DATE</a></li>
		</ul>
	...
	<center><h4>WELCOME TO DASHBOARD</h4></center>
